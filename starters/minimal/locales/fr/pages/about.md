...
<div class="container">
  ...
  <section class="contact">
    ...
    <div class="contact-content">
      <p>Vous avez une question ou souhaitez collaborer? N'hésitez pas à me contacter.</p>
      <a href="mailto:votre@email.com" class="btn btn-primary"><i class="fa-solid fa-envelope"></i> Contactez-moi</a>
    </div>
  </section>
</div>
