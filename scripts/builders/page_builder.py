...
class PageBuilder:
    ...
    def build_root_redirect(self) -> None:
        ...
        is_unilingual = len(self.site_config["languages"]) == 1
        redirection_url = (
            "/" if is_unilingual else f"/{self.site_config['languages'][0]}/"
        )
...
"""
    ...
    def build_taxonomy_pages(
        self, taxonomy_type: str, taxonomy_dict: dict, template_name: str
    ) -> None:
    ...
    def build_category_pages(self, categories: dict) -> None:
        ...
        self.build_taxonomy_pages("categories", categories, "pages/category.html")
