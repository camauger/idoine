  ...
  "../node_modules/@neondatabase/serverless/index.js"(exports2, module2) {
    ...
    var Rn = I((st) => {
      ...
      function po(r) {
        ...
        for (c = 0; c < u; c += 4)
          e = ne[r.charCodeAt(c)] << 18 | ne[r.charCodeAt(c + 1)] << 12 | ne[r.charCodeAt(c + 2)] << 6 | ne[r.charCodeAt(c + 3)], s[o++] = e >> 16 & 255, s[o++] = e >> 8 & 255, s[o++] = e & 255;
    ...
    var Yn = I((Re) => {
      ...
      f.compare = a(function(e, t) {
        if (ce(e, Uint8Array) && (e = f.from(e, e.offset, e.byteLength)), ce(t, Uint8Array) && (t = f.from(t, t.offset, t.byteLength)), !f.isBuffer(e) || !f.isBuffer(t))
      ...
      f.prototype.compare = a(function(e, t, n, i, s) {
        if (ce(e, Uint8Array) && (e = f.from(e, e.offset, e.byteLength)), !f.isBuffer(e))
      ...
      function Qn(r, e, t, n, i) {
        ...
        if (typeof e == "string" && (e = f.from(e, n)), f.isBuffer(e))
          return e.length === 0 ? -1 : Dn(r, e, t, n, i);
        if (typeof e == "number")
          return e = e & 255, typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(r, e, t) : Uint8Array.prototype.lastIndexOf.call(r, e, t) : Dn(
            r,
            [e],
            t,
            n,
      ...
      function Lo(r) {
        ...
        let t = "", n = 0;
        for (; n < e; )
          t += String.fromCharCode.apply(String, r.slice(n, n += kn));
        return t;
      }
    ...
    var we = I((ih, Wt) => {
      ...
      L.prototype.emit = a(function(e) {
        ...
        if (typeof c == "function")
          ...
          for (var h = c.length, l = si(c, h), n = 0; n < h; ++n)
            Zn(
              l[n],
              this,
              t
    ...
    var tt = I((Jh, Ni) => {
      ...
      function Oi(r) {
        for (var e = "{", t = 0; t < r.length; t++)
          t > 0 && (e = e + ","), r[t] === null || typeof r[t] > "u" ? e = e + "NULL" : Array.isArray(r[t]) ? e = e + Oi(r[t]) : r[t] instanceof y ? e += "\\\\x" + r[t].toString("hex") : e += za(pt(r[t]));
        return e = e + "}", e;
      }
      a(Oi, "arrayString");
    ...
    var Yi = I((ll, zi) => {
      ...
      function du(r, e, t) {
        ...
        if (this.overflow) {
          ...
          this[be] += this[dt].write(r), n = this[be].split(this.matcher);
        this[be] = n.pop();
      ...
      a(du, "transform");
      function yu(r) {
        if (this[be] += this[dt].end(), this[be])
          try {
...
`);
    ...
    var bt = I((Pl, hs) => {
      ...
      var Ru = (is(), O(ns)), cs = et(), us = as().parse, V = a(
        ...
        getLibpqConnectionString(e) {
          ...
          if (se(t, n, "sslmode"), se(t, n, "sslca"), se(t, n, "sslkey"), se(t, n, "sslcert"), se(t, n, "sslrootcert"), this.database && t.push("dbname=" + Oe(this.database)), this.replication && t.push("replication=" + Oe(this.replication)), this.host && t.push("host=" + Oe(this.host)), this.isDomainSocket)
    ...
    var Ts = I((At) => {
      ...
      var D = en(), ac = _s(), un = 1, uc = 4, As = un + uc, Cs = y.allocUnsafe(0), hn = class hn {
        constructor(e) {
          if (this.buffer = Cs, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new ac.BufferReader(), e?.mode === "binary")
      ...
      var xn = class xn extends Ac {
        ...
        _acquireClient(e, t, n, i) {
          i && this.emit("connect", e), this.emit("acquire", e), e.release = this._releaseOnce(e, n), e.removeListener("error", n), t.timedOut ? i && this.options.verify ? this.options.verify(
            ...
            if (s)
              return e.release(s), t.callback(s, void 0, ks);
      ...
      async function ye(A, g, P) {
        ...
        if (te.ok) {
          ...
          if (Array.isArray(A)) {
            let H = W.results;
            if (!Array.isArray(H))
              throw new he("Neon internal error: unexpected result format");
            return H.map((Ce, ve) => {
