...
var require_serverless = __commonJS({
  "node_modules/@neondatabase/serverless/index.js"(exports2, module2) {
    ...
    var Yn = I((Re) => {
      "use strict";
      p();
      var Dt = Rn(), Be = Fn(), Mn = typeof Symbol == "function" && typeof Symbol.for == "function" ? /* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom") : null;
      Re.Buffer = f;
      Re.SlowBuffer = vo;
    ...
    var Yi = I((ll, zi) => {
      "use strict";
      p();
      var { Transform: fu } = (hr(), O(cr)), { StringDecoder: pu } = ($i(), O(Gi)), be = /* @__PURE__ */ Symbol("last"), dt = /* @__PURE__ */ Symbol("decoder");
      function du(r, e, t) {
        let n;
        if (this.overflow) {
...
var sendInscriptionConfirmation_exports = {};
__export(sendInscriptionConfirmation_exports, {
  buildCourseLabel: () => buildCourseLabel,
  sendInscriptionConfirmation: () => sendInscriptionConfirmation
});
...
var RESEND_URL;
var init_sendInscriptionConfirmation = __esm({
  "netlify/functions/lib/sendInscriptionConfirmation.mjs"() {
...
exports.handler = async (event) => {
  try {
    ...
    const form_name = payload.form_name || payload.form || body.form_name || data && data["form-name"] || data && data.form_name;
    console.log("Received submission:", JSON.stringify({ form_name, data_keys: Object.keys(data || {}) }));
    const isInscription = form_name === "inscription" || data && data["form-name"] === "inscription" || data && data.form_name === "inscription";
    if (!isInscription) {
    ...
    const courseIdFromField = data.course_id != null && String(data.course_id).trim() !== "" ? String(data.course_id).trim() : "";
    ...
    `;
    const { sendInscriptionConfirmation: sendInscriptionConfirmation2, buildCourseLabel: buildCourseLabel2 } = await Promise.resolve().then(() => (init_sendInscriptionConfirmation(), sendInscriptionConfirmation_exports));
    const courseLabel = buildCourseLabel2(courseRows[0]);
    await sendInscriptionConfirmation2({
      to: courriel,
